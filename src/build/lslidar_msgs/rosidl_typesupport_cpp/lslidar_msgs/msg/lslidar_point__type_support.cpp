...
static const _LslidarPoint_type_support_symbol_names_t _LslidarPoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lslidar_msgs, msg, LslidarPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lslidar_msgs, msg, LslidarPoint)),
  }
};
...
{
  return &::lslidar_msgs::msg::rosidl_typesupport_cpp::LslidarPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lslidar_msgs, msg, LslidarPoint)() {
  return get_message_type_support_handle<lslidar_msgs::msg::LslidarPoint>();
}
