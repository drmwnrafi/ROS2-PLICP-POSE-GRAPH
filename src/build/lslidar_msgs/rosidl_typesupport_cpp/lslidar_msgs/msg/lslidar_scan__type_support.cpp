...
static const _LslidarScan_type_support_symbol_names_t _LslidarScan_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lslidar_msgs, msg, LslidarScan)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lslidar_msgs, msg, LslidarScan)),
  }
};
...
{
  return &::lslidar_msgs::msg::rosidl_typesupport_cpp::LslidarScan_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lslidar_msgs, msg, LslidarScan)() {
  return get_message_type_support_handle<lslidar_msgs::msg::LslidarScan>();
}
