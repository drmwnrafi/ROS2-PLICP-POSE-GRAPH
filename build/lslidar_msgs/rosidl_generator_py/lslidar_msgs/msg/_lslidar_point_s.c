...
bool lslidar_msgs__msg__lslidar_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lslidar_msgs.msg._lslidar_point.LslidarPoint", full_classname_dest, 44) == 0);
  }
  lslidar_msgs__msg__LslidarPoint * ros_message = _ros_message;
  {  // time
  ...
  {  // intensity
    ...
    assert(PyFloat_Check(field));
    ros_message->intensity = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of LslidarPoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lslidar_msgs.msg._lslidar_point");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LslidarPoint");
