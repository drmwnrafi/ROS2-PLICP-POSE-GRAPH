...
bool wheel_interfaces__msg__wheel_infos__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wheel_interfaces.msg._wheel_infos.WheelInfos", full_classname_dest, 44) == 0);
  }
  wheel_interfaces__msg__WheelInfos * ros_message = _ros_message;
  {  // position
  ...
  {  // cmd_value
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->cmd_value.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'cmd_value'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of WheelInfos */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("wheel_interfaces.msg._wheel_infos");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WheelInfos");
  ...
  {  // cmd_value
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "cmd_value");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->cmd_value.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->cmd_value.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->cmd_value.size * sizeof(int32_t));
      assert(data != NULL);
