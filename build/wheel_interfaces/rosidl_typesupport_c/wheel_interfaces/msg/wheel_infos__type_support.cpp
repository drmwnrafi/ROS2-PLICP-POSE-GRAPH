...
static const _WheelInfos_type_support_symbol_names_t _WheelInfos_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wheel_interfaces, msg, WheelInfos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wheel_interfaces, msg, WheelInfos)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wheel_interfaces, msg, WheelInfos)() {
  return &::wheel_interfaces::msg::rosidl_typesupport_c::WheelInfos_message_type_support_handle;
}
