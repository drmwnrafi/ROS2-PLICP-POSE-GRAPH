...
class ROSBoardNode(object):
    ...
    def __init__(self, node_name = "rosboard_node"):
        ...
        self.address = rospy.get_param("~address", '127.0.0.1')
        ...
        self.tornado_application.listen(self.port, self.address)
        ...
        rospy.loginfo(f"ROSboard listening on : http://{self.address}:{self.port}/")
